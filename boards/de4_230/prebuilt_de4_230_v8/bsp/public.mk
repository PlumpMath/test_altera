...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../../vblox1.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../../vblox1.sopcinfo
...
#------------------------------------------------------------------------------
#             SOFTWARE COMPONENT & DRIVER-PROVIDED LIBRARIES
#------------------------------------------------------------------------------

ALT_LIBRARY_DIRS += $(ALT_LIBRARY_ROOT_DIR)/vbxapi/lib
ALT_BSP_DEP_LIBRARY_NAMES += vbxlib
